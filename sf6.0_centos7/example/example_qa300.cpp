...
int main(int argc, char ** argv) {
		...
		seeta::FaceDetector FD(seeta::ModelSetting("./model/face_detector.csta"));

		seeta::FaceLandmarker PD(seeta::ModelSetting("./model/face_landmarker_pts5.csta"));
	
        seeta::ModelSetting posemodel;
        posemodel.set_device(SEETA_DEVICE_CPU);
        posemodel.set_id(0); 
        posemodel.append("./model/pose_estimation.csta");
        ...
        lbnmodel.append("./model/quality_lbn.csta");
        ...
        setting3.append( "./model/face_landmarker_pts68.csta" );
        seeta::FaceLandmarker PD68( setting3 );

        seeta::ModelSetting setting4;
        setting4.set_device(SEETA_DEVICE_CPU);
        setting4.set_id(0); 
        setting4.append("./model/face_landmarker_mask_pts5.csta");
