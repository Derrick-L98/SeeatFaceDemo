...
int main_video()
{
	...
	const char* model_path = "./model/gender_predictor.csta";
	seeta::ModelSetting setting(model_path);
	seeta::GenderPredictor GP(setting);
	
	std::string title = "GenderPredictor";
